        ...
        var l = function() {
            ...
            return i(e, [{
                ...
                value: function() {
                    ...
                    this.player.template.title.innerHTML = "空列表",
        ...
        var s = function() {
            ...
            return a(e, [{
                ...
                value: function(e) {
                    ...
                    if (!this.parsed[e])
                        if (this.async) {
                            this.parsed[e] = [["00:00", "正在加载"]];
                            var n = new XMLHttpRequest;
                            n.onreadystatechange = function() {
                                e === t.player.list.index && 4 === n.readyState && (n.status >= 200 && n.status < 300 || 304 === n.status ? t.parsed[e] = t.parse(n.responseText) : (t.player.notice("歌词文件请求失败: status " + n.status),
                                t.parsed[e] = [["00:00", "无数据"]]),
                            ...
                            this.player.list.audios[e].lrc ? this.parsed[e] = this.parse(this.player.list.audios[e].lrc) : this.parsed[e] = [["00:00", "无数据"]];
